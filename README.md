...
+ 当介质厚度$l$以$cm$为单位，吸光物质浓度$c$以$g/L$为单位时，$K$用$a$表示，称为吸收系数，其单位为$L/g·cm$。这时朗伯-比尔定律表示为$A=alc$。<br>
+ 当介质厚度$l$以$cm$为单位，吸光物质浓度$c$以$mol/L$为单位时，$K$用$ε$表示，称为摩尔吸收系数，其单位为$L/mol·cm$。这时朗伯-比尔定律表示为$A=εlc$。<br>
