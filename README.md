...
根据上述理论我们需要的发光二极管的光照需要穿透深度大、波长范围窄、近似于平行光等特点。所以选择激光二极管是再好不过了。<br>
## 光电二极管选择
### OPT101
...
$$C_1 \leqslant \frac{1}{2\pi R_1 f_p} = \frac{1}{2\pi\times 1M\Omega \times 10KHz} \leqslant 15.92pF\approx 16pF$$
