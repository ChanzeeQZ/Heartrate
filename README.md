...
# 1 器件选型与比较
## 1.1 发光二极管选择
发光二极管因选用红色(620~780nm)、低功耗、高亮度(100mcd左右)、在-30~40℃均可正常工作。<br>
所以选择了ASMT-RR45-AQ902.<br>
## 光电二极管选择
选用集成化的OPT101.<br>
## 滤波器选择
### 方案1 - TLV2402
...
由于Arduino IDE程序有非常多的函数和头文件的资源可以调用，有因为在本次实验中不需要硬件电路的搭建，故选择Arduino UNO作为本次实验的处理器。<br>
